...
create table Student_Info_895183 (
...
create table Subject_Master_895183 (
...
create table Student_Marks_895183 (
Reg_Number  Varchar(40),
Subject_Code  varchar(10),
Semester int,
Marks int
)
select*from Student_Marks_895183

--Create Student_Result table
create table Student_Result_895183 (
Reg_Number Varchar(40),
Semester int,
GPA int,
...
insert into Student_Info_895183 values
...
insert into Subject_Master_895183 values
('EE01DCF','DCF',30),
...
insert into Student_Marks_895183 values('MC101301','EE01DCF',1,75),
...
insert into Student_Result_895183 values('MC101301',1,7.5,'Y'),
('BEC111402',1,7.1,'Y'),
('BEEI101204',1,8.3,'Y'),
('BEEI101204',2,6.9,'N'),
('MB111305',1,6.5,'N'),
