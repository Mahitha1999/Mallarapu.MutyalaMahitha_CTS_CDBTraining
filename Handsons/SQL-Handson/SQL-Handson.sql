...
Questions_Id varchar(20) primary key,
...
--(Insert details into table Batch_Info)
...
--(Insert details into table Module_Info)
...
--(Insert details into table Associate_Info)
...
--(Insert details into table Questions)
...
truncate table Associate_Status
--(Insert details into table Associate_Status)
insert into Associate_Status (Associate_Id,Module_Id,Start_Date,End_Date,Batch_Id,Trainer_Id) values
...
delete from Associate_Status where Start_Date='2005-12-1' and End_Date='2005-12-25';
select*from Associate_Status;
